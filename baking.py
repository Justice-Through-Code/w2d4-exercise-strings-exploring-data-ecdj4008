...
def print_ingredients():  # Ways to work with strings/printing
    ...
    print("Ingredients: " + ingredient_1 + ", " + ingredient_2 + ", " + ingredient_3 + ", " + ingredient_4)

    # 1.3 Using one print statement, use an f-string to print the ingredients
    # as a single string (make sure to add a space between each ingredient!)
    print(f"Ingredients: {ingredient_1}, {ingredient_2}, {ingredient_3}, {ingredient_4}")
...
def confirm_ingredients():  # String methods
    ...
    ingredients = f"Ingredients: {ingredient_1}, {ingredient_2}, {ingredient_3}, {ingredient_4}"
    ...
    count_of_milk = f"{ingredient_1} {ingredient_2} {ingredient_3} {ingredient_4}".count('milk')
    print(f"The word 'milk' appears {count_of_milk} times in the combined string.")
